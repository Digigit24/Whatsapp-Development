<?php $logStatus = request()->get('logStatus'); ?>
...
{{-- datatable queue log--}}
<x-lw.datatable lw-card-classes="border-0" data-page-length="100" id="lwCampaignQueueLog" :url="route('vendor.campaign.queue.log.list.view', ['campaignUid' => $campaignUid, 'logStatus' => $logStatus])">
